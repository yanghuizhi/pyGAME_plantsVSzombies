...
import pygame
import random
# from common.map_class import Map
#1 配置图片地址
IMAGE_PATH = 'imgs/'
#1 设置页面宽高
scrrr_width=800
...
class WallNut(Plant):
    def __init__(self,x,y):
        ...
        self.image=pygame.image.load('imgs/wallnut2.png')
        ...
        for e in eventList:
            if e.type == pygame.QUIT:
                ...
                # 坚果加入2
                    ...
                    if map.can_grow and MainGame.money >=50:
                        wallnut=WallNut(map.position[0],map.position[1])
                        MainGame.plants_list.append(wallnut)
                        print("当前植物列表长度{}".format(len(MainGame.plants_list)))
                        map.can_grow=False
                        MainGame.money -=50
